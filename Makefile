...
$(OBJDIR)/iwlio.o: iwleeprom.h iwlio.h iwlio.c
		gcc -gdwarf -Wall $(CFLAGS) -c -o $(OBJDIR)/iwlio.o iwlio.c

$(OBJDIR)/ath5kio.o: iwleeprom.h ath5kio.h ath5kio.c
		gcc -gdwarf -Wall $(CFLAGS) -c -o $(OBJDIR)/ath5kio.o ath5kio.c

$(OBJDIR)/ath9kio.o: iwleeprom.h ath9kio.h ath9kio.c
		gcc -gdwarf -Wall $(CFLAGS) -c -o $(OBJDIR)/ath9kio.o ath9kio.c
